  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-500 mt-1 text-sm">Join Concept Coaching Classes</p>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition text-sm font-medium"
      >
